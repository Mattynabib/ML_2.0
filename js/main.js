...
This stuff pulls in my latest 3 twitter feeds
...
function twitterCallback2(twitters) {
  ...
  for (var i=0; i<twitters.length; i++){
    ...
    statusHTML.push('<li><a style="font-size:85%" href="http://twitter.com/'+username+'/statuses/'+twitters[i].id_str+'"><span class="theTweet">'+status+'  --  </span></a><a style="font-size:85%" href="http://twitter.com/'+username+'/statuses/'+twitters[i].id_str+'">'+relative_time(twitters[i].created_at)+'</a></li>');
  }
...
NOTE: This one has undergone some pretty severe modification by
Matt Laurence, for my own web site
**/

// set to be the URL of your RSS feed
var feedURL 			= 'http://thegrandnabib.blogspot.com/feeds/posts/default';
...
*/				$('<span>').addClass('feedDate').text(entryDate).appendTo('#'+ entryID);
				$('<h3>').append($('<a>').attr('href',entryURL).text(entryTitle)).appendTo("#"+ entryID);
				$('<p>').addClass('feedBlurb').text(entryBlurb).appendTo('#'+ entryID);
				if (entryBlurb == "" || entryBlurb == null) {
					$(targetLocation).append($('<p>It appears that either I have absolutely nothing to say, or your connection to my feed has been severed by bandits.</p>')); 
				}
			}
